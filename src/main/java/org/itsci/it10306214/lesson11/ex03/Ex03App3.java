...
public class Ex03App3 {
    ...
    public static void main(String[] args) {
        ...
        Predicate predicate = builder.between(root.get("gpa").as(Double.class), 3.0, 4.0);
        // Predicate predicate = root.get("major").in("Computer Science", "Information
        // Technology");
